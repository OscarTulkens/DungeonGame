	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput vert ( VertexInput v  )
			{
				...
				float4 transform53_g2 = mul(GetObjectToWorldMatrix(),float4( v.vertex.xyz , 0.0 ));
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				float4 appendResult65_g2 = (float4(( ase_worldPos.x * 0.0 ) , ase_worldPos.y , ase_worldPos.z , 0.0));
				float4 transform56_g2 = mul(GetWorldToObjectMatrix(),( transform53_g2 + float4( ( pow( distance( appendResult65_g2 , float4( PlayerPosition , 0.0 ) ) , 2.0 ) * CurveMultiplier * float3(0,1,0) ) , 0.0 ) ));
				...
				#endif
				float3 vertexValue = transform56_g2.xyz;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( Fresnel136 + lerpResult110 ).rgb;
				float Alpha = Opacity;
...
/*ASEBEGIN
Version=17900
-2250;207;629;571;719.9883;592.8706;1.47352;False;False
Node;AmplifyShaderEditor.CommentaryNode;138;-820.3256,-1345.589;Inherit;False;989.6239;503.0596;Fresnel;6;131;134;128;133;135;136;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;113;-2716.245,1455.148;Inherit;False;1474.596;539.8811;FogData;10;102;103;104;99;105;107;100;106;109;111;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;68;-3034.487,494.191;Inherit;False;2046.296;909.1974;TopColor;14;80;79;78;77;76;75;72;71;70;69;91;92;95;114;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;54;-3032.569,-1365.372;Inherit;False;2046.296;909.1974;RightColor;14;47;48;44;46;14;11;9;12;52;53;86;89;93;139;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;55;-3031.372,-437.149;Inherit;False;2046.296;909.1974;FrontColor;14;67;66;65;64;63;62;59;58;57;56;87;88;94;140;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;143;589.8916,475.682;Inherit;False;Global;CurveMultiplier;CurveMultiplier;9;0;Create;True;0;0;False;0;0;-5.605194E-45;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;111;-1465.649,1828.21;Inherit;False;FogData;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;137;761.1512,-204.4621;Inherit;False;136;Fresnel;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;109;-1606.602,1833.151;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector;114;-2948.669,613.7225;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.AbsOpNode;103;-2475.817,1604.392;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;107;-2070.504,1860.029;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;104;-2338.817,1606.633;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;106;-1741.638,1833.392;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;105;-2001.443,1603.633;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;142;785.7454,421.5096;Inherit;False;TerrainBend;-1;;2;1e2b703ce37c8764cbded96f80bd4b28;0;1;71;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-745.6149,-1237.931;Inherit;False;Property;_FresnelScale;FresnelScale;7;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;132;1006.858,-154.6831;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldPosInputsNode;102;-2666.245,1603.694;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;144;787.3184,226.4065;Inherit;False;Global;Opacity;Opacity;9;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;139;-2955.738,-1259.272;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.WorldNormalVector;140;-2973.215,-343.7939;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;99;-2286.23,1505.148;Inherit;False;Property;_FogStartPos;FogStartPos;5;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;128;-558.8829,-1096.53;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;101;270.682,-32.71616;Inherit;False;Property;_FogColor;FogColor;3;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;100;-2286.769,1877.276;Inherit;False;Property;_FogEndPos;FogEndPos;4;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;133;-256.5512,-1121.585;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;131;-498.5092,-1295.589;Inherit;False;Property;_FresnelColor;FresnelColor;6;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;135;-770.3256,-1138.059;Inherit;False;Property;_FresnelPower;FresnelPower;8;0;Create;True;0;0;False;0;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;136;-54.70157,-1129.003;Inherit;False;Fresnel;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;112;302.8062,160.0937;Inherit;False;111;FogData;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;124;1163.404,1.678643;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;Custom/CrystalShader;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;7;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;1;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;11;Surface;1;  Blend;0;Two Sided;1;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;0;Meta Pass;0;Extra Pre Pass;0;Vertex Position,InvertActionOnDeselection;0;0;5;False;True;True;True;False;False;;0
...
WireConnection;142;71;143;0
WireConnection;63;0;64;0
WireConnection;58;0;140;0
...
WireConnection;124;3;144;0
WireConnection;124;5;142;0
ASEEND*/
//CHKSM=2CBDD717916A67C47A87DED5BC24EA0E320080CE